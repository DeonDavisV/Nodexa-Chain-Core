...
#ifndef CLORE_QT_CloreGUI_H
#define CLORE_QT_CloreGUI_H
...
/**
  clore GUI main class. This class represents the main window of the clore UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class CloreGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit CloreGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~CloreGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a clore wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
