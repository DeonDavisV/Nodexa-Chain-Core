...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(CloreUnits::CLORE),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->cloreBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->cloreBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(CloreUnits::formatWithUnit(unit, balance, false, CloreUnits::separatorAlways));
    ui->labelUnconfirmed->setText(CloreUnits::formatWithUnit(unit, unconfirmedBalance, false, CloreUnits::separatorAlways));
    ui->labelImmature->setText(CloreUnits::formatWithUnit(unit, immatureBalance, false, CloreUnits::separatorAlways));
    ui->labelTotal->setText(CloreUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, CloreUnits::separatorAlways));
    ui->labelWatchAvailable->setText(CloreUnits::formatWithUnit(unit, watchOnlyBalance, false, CloreUnits::separatorAlways));
    ui->labelWatchPending->setText(CloreUnits::formatWithUnit(unit, watchUnconfBalance, false, CloreUnits::separatorAlways));
    ui->labelWatchImmature->setText(CloreUnits::formatWithUnit(unit, watchImmatureBalance, false, CloreUnits::separatorAlways));
    ui->labelWatchTotal->setText(CloreUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, CloreUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("CLORE")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the CLORE balance grid from expanding and looking terrible when asset balance is hidden
