...
#include "config/clore-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatCloreURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + CloreUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatCloreURI(info));
}
