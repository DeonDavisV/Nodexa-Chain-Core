...
WalletModel::SendCoinsReturn WalletModel::prepareTransaction(WalletModelTransaction &transaction, const CCoinControl& coinControl)
{
    ...
    for (const SendCoinsRecipient &rcp : recipients)
    {
        ...
        {   // User-entered clore address / amount:
...
WalletModel::SendCoinsReturn WalletModel::sendCoins(WalletModelTransaction &transaction)
{
...

    {
        ...
        for (const SendCoinsRecipient &rcp : transaction.getRecipients())
        {
            ...
            else if (!rcp.message.isEmpty()) // Message from normal clore:URI (clore:123...?message=example)
...
//    questionString.append(CloreUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), oldFee));
//    questionString.append("</td></tr><tr><td>");
//    questionString.append(tr("Increase:"));
//    questionString.append("</td><td>");
//    questionString.append(CloreUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), newFee - oldFee));
//    questionString.append("</td></tr><tr><td>");
//    questionString.append(tr("New fee:"));
//    questionString.append("</td><td>");
//    questionString.append(CloreUnits::formatHtmlWithUnit(getOptionsModel()->getDisplayUnit(), newFee));
