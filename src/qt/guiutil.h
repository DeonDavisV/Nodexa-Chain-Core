...
#ifndef CLORE_QT_GUIUTIL_H
#define CLORE_QT_GUIUTIL_H
...
/** Utility functions used by the clore Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "clore:" URI into recipient object, return true on successful parsing
