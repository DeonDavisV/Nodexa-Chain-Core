...
void WalletView::setCloreGUI(CloreGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? CloreGUI::HD44_ENABLED : _walletModel->hdEnabled() ? CloreGUI::HD_ENABLED : CloreGUI::HD_DISABLED);
