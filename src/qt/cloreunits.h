...
#ifndef CLORE_QT_CLOREUNITS_H
#define CLORE_QT_CLOREUNITS_H
...
/** clore unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CloreUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CloreUnits(QObject *parent);
...
typedef CloreUnits::Unit CloreUnit;

#endif // CLORE_QT_CLOREUNITS_H
