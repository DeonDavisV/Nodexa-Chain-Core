...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<CloreAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_clore-qt -platform xcb      # Linux
//     src/qt/test/test_clore-qt -platform windows  # Windows
//     src/qt/test/test_clore-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = CloreUnits::formatWithUnit(unit, balance, false, CloreUnits::separatorAlways);
    ...
    // Amount input
    CloreAmountField* amountInput = receiveCoinsDialog.findChild<CloreAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: clore:")) != -1);
