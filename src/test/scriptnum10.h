...
#ifndef CLORE_TEST_SCRIPTNUM10_H
#define CLORE_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Clore Core 0.10.0, for cross-comparison.
 */
public:
