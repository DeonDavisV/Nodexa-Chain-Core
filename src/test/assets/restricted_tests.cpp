...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler clore tx
        CScript cloreTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut cloreOut(1*COIN, cloreTransfer);
        ...
        mutTxTest1.vout.emplace_back(cloreOut); 
        ...
        mutTxTest2.vout.emplace_back(cloreOut);
        ...
        mutTxTest3.vout.emplace_back(cloreOut);
        ...
        mutTxTest4.vout.emplace_back(cloreOut);
        ...
        mutTxTest5.vout.emplace_back(cloreOut);
        ...
        mutTxTest6.vout.emplace_back(cloreOut);
        ...
        mutTxTest7.vout.emplace_back(cloreOut);
        ...
        mutTxTest8.vout.emplace_back(cloreOut);
