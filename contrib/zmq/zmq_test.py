...
"""
    ...
    Clore should be started with the command line arguments:
        clore_blockchaind -testnet -daemon \
...
while True:
	...
	if topic == b"hashblock":
		...
		while(pos != -1):
			...
			if (pos > -1):
				print("FOUND CLORE issuance at " + str(pos))
				print("After CLORE: " + astr[pos+6:pos+8])
			...
			pos = astr.find('72766e', start)
			if (pos > -1):
				print("FOUND CLORE something at " + str(pos))
			start += pos+8
			print(astr)
