Clore Core version *2.4.0* is now available!!
==============
...
Please report bugs using the issue tracker at GitHub:
  ...
  <https://gitlab.com/cloreai-public/blockchain/issues>

To receive security and update notifications, please subscribe to:

  <https://blockchain.clore.ai/en/list/announcements/join/>
...
installer (on Windows) or just copy over `/Applications/Clore-Qt` (on Mac)
or `clore_blockchaind`/`clore-qt` (on Linux).
...
Clore Core is extensively tested on multiple operating systems using
the Linux kernel, macOS 10.8+, and Windows 10(x64) and later. 32-bit versions of Windows,
and Windows XP are not supported.

Clore Core should also work on most other Unix-like systems but is not
frequently tested on them.

Clore Core has been tested with macOS 10.14 Mojave, but it is recommended that *developers*
...
Clore Core has not been tested with macOS Catalina(beta). Please use at your own risk.
...
Changelog available here: <https://gitlab.com/cloreai-public/blockchain/commits/release_2.4.0>
...
- Most importantly - The Clore Community!
