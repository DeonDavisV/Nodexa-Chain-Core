...
This document provides guidelines for internationalization of the Clore Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `clore_en.ts` remains unchanged.
