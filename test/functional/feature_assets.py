...
class AssetTest(CloreTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("CLORE1", 1000)
        n0.issue("CLORE2", 1000)
        n0.issue("CLORE3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="CLORE*", verbose=False, count=2, start=-2)
        ...
        clore_assets = n0.listassets(asset="CLORE*", verbose=False, count=2, start=-2)
        assert_equal(len(clore_assets), 2)
        assert_equal(clore_assets[0], "CLORE2")
        assert_equal(clore_assets[1], "CLORE3")
        self.sync_all()
