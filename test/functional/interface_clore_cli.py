...
class TestCloreCli(CloreTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `clore-cli getinfo`")
        ...
        self.log.info("Compare responses from `clore-cli -getinfo` and the RPCs data is retrieved from.")
