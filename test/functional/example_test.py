...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the CloreTestFramework
    pass

class ExampleTest(CloreTestFramework):
    # Each functional test is a subclass of the CloreTestFramework class.
    ...
    def custom_method(self):
        ...
        CloreTestFramework class so other tests can use it."""
