...
By default, clore_blockchaind will dump mempool on shutdown and
...
class MempoolPersistTest(CloreTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give clore_blockchaind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent clore_blockchaind from writing mempool.dat to disk. Verify that `savemempool` fails")
