...
# TestNode: A peer we use to send messages to clore_blockchaind, and store responses.
...
class CompactBlocksTest(CloreTestFramework):
    ...
    # This test actually causes clore_blockchaind to (reasonably!) disconnect us, so do this last.
    ...
    # clore_blockchaind's choice of nonce.
    ...
    # Test that clore_blockchaind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for clore_blockchaind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # clore_blockchaind will not send blocktxn responses for blocks whose height is
