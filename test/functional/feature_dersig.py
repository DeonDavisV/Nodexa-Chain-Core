...
class BIP66Test(CloreTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # clore_blockchaind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and clore_blockchaind produces more specific reject
            # reasons.
