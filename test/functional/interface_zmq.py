...
import os
import struct
from test_framework.test_framework import CloreTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(CloreTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that clore has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("clore_blockchaind has not been built with zmq enabled.")
