...
class WalletTest(CloreTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 CLORE from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 CLORE with subtract fee from amount
        ...
        # Sendmany 10 CLORE with subtract fee from amount
