...
class TxnMallTest(CloreTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 CLORE:
        ...
        # First: use raw transaction API to send 1240 CLORE to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 CLORE coin each
        ...
        # Node0's balance should be starting balance, plus 50CLORE for another
        ...
        # Node0's total balance should be starting balance, plus 100CLORE for 
